...
public class ModPotions {
    ...
    public static final Potion CORRUPTION_POTION;
    ...
    public static final Potion STRONG_DOLPHIN;


    static {
        CORRUPTION_POTION = registerPotion("corruption_potion", new Potion(new StatusEffectInstance(ExperimentMod.CORRUPTED, 3000, 0)));
        ...
        STRONG_WITHER = registerPotion("strong_wither_potion", new Potion(new StatusEffectInstance(StatusEffects.WITHER, 3000, 1)));
        ...
        STRONG_HUNGER = registerPotion("strong_hunger_potion", new Potion(new StatusEffectInstance(StatusEffects.HUNGER, 3000, 1)));
        ...
        STRONG_MINING_FATIGUE = registerPotion("strong_mining_fatigue_potion", new Potion(new StatusEffectInstance(StatusEffects.MINING_FATIGUE, 3000, 1)));
        ...
        STRONG_ABSORPTION = registerPotion("strong_absorption_potion", new Potion(new StatusEffectInstance(StatusEffects.ABSORPTION, 3000, 1)));
        ...
        STRONG_DOLPHIN = registerPotion("strong_dolphin_potion", new Potion(new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 3000, 1)));
    ...
    public static void registerPotionRecipes() {
        ...
        BrewingRecipeRegistryMixin.invokeRegisterPotionRecipe(ModPotions.MINING_FATIGUE_POTION, Items.GLOWSTONE_DUST,
                ModPotions.STRONG_MINING_FATIGUE);
